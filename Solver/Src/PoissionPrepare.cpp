#include "PoissonPrepare.h"
#include "SolverData.h"
#include "OutputData.h"
#include "Triangle.h"
#include "Mesh.h"

PoissonPrepare::PoissonPrepare(SolverData* pSolver, OutputData* pOutData)
...
PoissonPrepare::~PoissonPrepare()
{
}

void PoissonPrepare::DoProcess()
{
    if (!m_pSolver)
    {
        return;
